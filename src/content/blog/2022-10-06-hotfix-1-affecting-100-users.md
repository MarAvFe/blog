...
description: "A story about a scripting mistake that accidentally disabled 100 users, and what I learned from it."
---
...
Even though this happened in our CICD pipeline execution, it would've happened in my local environment, as we had no test cases defined within the script. Not unit tests, not test values, nothing. Any way of testing would've caught this quickly.
...
<figure>
<img src="/posts/response.png" alt="column chart">
